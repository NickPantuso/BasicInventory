...
import com.group.basicinventory.model.*;
...
public class ProductController implements Initializable {
    ...
    @FXML private TableColumn<Part, Integer> associatedID = new TableColumn<>();
    @FXML private TableColumn<Part, String> associatedName = new TableColumn<>();
    @FXML private TableColumn<Part, Integer> associatedLvl = new TableColumn<>();
    @FXML private TableColumn<Part, Double> associatedPrice = new TableColumn<>();
    ...
    public void addSavedProduct() {
        ...
        if(associatedTable.getItems().size() > 0) hasAssociated = true;
        Product product = new Product(productIdCounter, nameText.getText(), Double.parseDouble(priceText.getText()),
                ...
                Integer.parseInt(maxText.getText()), hasAssociated);
